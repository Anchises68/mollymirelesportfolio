      ...
      <div className="container modal-body mb-5 mt-3">
        ...
        <div className="row">
          ...
          <div className="col-md-6 mb-2 mt-3">
            <h5>With 15 years experience, I have developed expertise in marketing, event planning, client relations and communications. I am a strong communicator, presenter and listener. In annual surveys, my clients expressed that my work for them has helped them achieve their goals.
