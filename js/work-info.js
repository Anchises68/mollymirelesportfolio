...
const WorkInfo = [
  ...
  },
  {
    ...
    'column_1': {
      ...
      'list': [
        "For this – our most successful fundraiser to date – I initiated contact with the speaker, professional surfer Bethany Hamilton, and coordinated the speaker contract. As lead of the planning committee, I directed the design for the pieces and the promotional campaign. I was also the speaker liaison the day of the event.",
        ""
      ]
    ...
    'column_2': {
      ...
      'list': [
        "I led the planning committee and directed event promotion for the community health fair at Highland Springs Medical Plaza, which featured 14 health screenings and 36 exhibitors."
    ...
    'column_3': {
      ...
      'list': [
        "I led the planning committee for the sixth annual food distribution on Friday, November 20, 2016 at Highland Springs Medical Plaza in Beaumont, CA. For this event, we partnered with Side by Side Humanitarian Food Bank to provide underserved families with groceries for the Thanksgiving holiday.",
        "We provided groceries to 610 families. The local newspaper, the Record Gazette, featured the event on the front page. I wrote a press release about the event, which was picked up by Channel 7 News. I liaised with the Channel 7 reporter and arranged for an interview with the Highland Springs Medical Plaza administrator."
      ]
    }
  },
  {
